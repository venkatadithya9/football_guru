...
Default: Google Gemini (gemini-3.1-flash-lite).
...
# ---- Google Gemini (Using API Key) ----------------------------------------
# Use this if you want to use the Google Gemini API directly with GEMINI_API_KEY.
...
# ---- Google Vertex AI (Using Service Account) ----------------------------
